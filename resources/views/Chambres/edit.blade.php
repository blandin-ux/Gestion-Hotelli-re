...
<head>
    ...
    <title> Modification de la chambre </title>
</head>
<body>
...
<div class="form-row">
    ...
    <div class="form-wrapper">
        ...
        <input value="{{$chambre->telephone}}" type="text" class="form-control" placeholder="Numéro de télephone" name="telephone" required>
    </div>
</div>
<div class="form-row">
<div class="form-wrapper">
